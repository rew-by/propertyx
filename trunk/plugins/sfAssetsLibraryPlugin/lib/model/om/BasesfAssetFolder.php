...
abstract class BasesfAssetFolder extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfAssetFolderPeer';
	...
	/**
	 * @var        array Property[] Collection to store aggregation of Property objects.
	 */
	protected $collPropertys;

	/**
	 * @var        Criteria The criteria used to select the current contents of collPropertys.
	 */
	private $lastPropertyCriteria = null;

	/**
	 * @var        array sfAsset[] Collection to store aggregation of sfAsset objects.
	 */
	protected $collsfAssets;

	/**
	 * @var        Criteria The criteria used to select the current contents of collsfAssets.
	 */
	private $lastsfAssetCriteria = null;
	...
	/**
	 * Initializes internal state of BasesfAssetFolder object.
	 * @see        applyDefaults()
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(sfAssetFolderPeer::TREE_LEFT,sfAssetFolderPeer::TREE_RIGHT))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->relative_path = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
			...
			return $startcol + 7; // 7 = sfAssetFolderPeer::NUM_COLUMNS - sfAssetFolderPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = sfAssetFolderPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->lastPropertyCriteria = null;

			$this->collsfAssets = null;
			$this->lastsfAssetCriteria = null;
    ...
    foreach (sfMixer::getCallables('BasesfAssetFolder:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			sfAssetFolderPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[4], $arr)) $this->setRelativePath($arr[$keys[4]]);
	...
	/**
	 * Clears out the collPropertys collection (array).
	 *
	...
	/**
	 * Initializes the collPropertys collection (array).
	 *
	 ...
	 * Otherwise if this sfAssetFolder has previously been saved, it will retrieve
	 * related Propertys from storage. If this sfAssetFolder is new, it will return
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
			   $this->collPropertys = array();
				...
				$criteria->add(PropertyPeer::SF_ASSET_FOLDER_ID, $this->id);

				PropertyPeer::addSelectColumns($criteria);
				$this->collPropertys = PropertyPeer::doSelect($criteria, $con);
			}
		} else {
	...
	public function countPropertys(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$count = PropertyPeer::doCount($criteria, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastPropertyCriteria) || !$this->lastPropertyCriteria->equals($criteria)) {
					...
					$count = count($this->collPropertys);
				}
			} else {
				$count = count($this->collPropertys);
			}
	...
	public function addProperty(Property $l)
	{
		...
		if (!in_array($l, $this->collPropertys, true)) { // only add it if the **same** object is not already associated
			array_push($this->collPropertys, $l);
	 ...
	 * Otherwise if this sfAssetFolder is new, it will return
	 * an empty collection; or if this sfAssetFolder has previously
	 * been saved, it will retrieve related Propertys from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in sfAssetFolder.
	 */
	public function getPropertysJoinOffer($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetFolderPeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collPropertys = PropertyPeer::doSelectJoinOffer($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfAssetFolder.
	 */
	public function getPropertysJoinType($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetFolderPeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collPropertys = PropertyPeer::doSelectJoinType($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfAssetFolder.
	 */
	public function getPropertysJoinTypology($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetFolderPeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collPropertys = PropertyPeer::doSelectJoinTypology($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfAssetFolder.
	 */
	public function getPropertysJoinState($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetFolderPeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collPropertys = PropertyPeer::doSelectJoinState($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	 ...
	 * actually need in sfAssetFolder.
	 */
	public function getPropertysJoinKitchen($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetFolderPeer::DATABASE_NAME);
		}
		...
		if ($this->collPropertys === null) {
			if ($this->isNew()) {
				...
				$this->collPropertys = PropertyPeer::doSelectJoinKitchen($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	/**
	 * Clears out the collsfAssets collection (array).
	 *
	 * This does not modify the database; however, it will remove any associated objects, causing
	 * them to be refetched by subsequent calls to accessor method.
	 *
	 ...
	 * @see        addsfAssets()
	 */
	public function clearsfAssets()
	{
		$this->collsfAssets = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collsfAssets collection (array).
	 *
	 * By default this just sets the collsfAssets collection to an empty array (like clearcollsfAssets());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	...
	/**
	 * Gets an array of sfAsset objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this sfAssetFolder has previously been saved, it will retrieve
	 * related sfAssets from storage. If this sfAssetFolder is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array sfAsset[]
	 * @throws     PropelException
	 */
	public function getsfAssets($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(sfAssetFolderPeer::DATABASE_NAME);
		}
	...
	public function addsfAsset(sfAsset $l)
	{
		...
		if (!in_array($l, $this->collsfAssets, true)) { // only add it if the **same** object is not already associated
			array_push($this->collsfAssets, $l);
			$l->setsfAssetFolder($this);
		}
	}
	...
	public function clearAllReferences($deep = false)
	{
		if ($deep) {
			if ($this->collPropertys) {
				foreach ((array) $this->collPropertys as $o) {
					$o->clearAllReferences($deep);
				}
			}
			if ($this->collsfAssets) {
				foreach ((array) $this->collsfAssets as $o) {
					$o->clearAllReferences($deep);
				}
			}
		} // if ($deep)
