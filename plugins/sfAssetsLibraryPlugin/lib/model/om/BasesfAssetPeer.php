...
abstract class BasesfAssetPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'folderId', 'filename', 'description', 'author', 'copyright', 'type', 'filesize', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FOLDER_ID, self::FILENAME, self::DESCRIPTION, self::AUTHOR, self::COPYRIGHT, self::TYPE, self::FILESIZE, self::CREATED_AT, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'folderId' => 1, 'filename' => 2, 'description' => 3, 'author' => 4, 'copyright' => 5, 'type' => 6, 'filesize' => 7, 'createdAt' => 8, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FOLDER_ID => 1, self::FILENAME => 2, self::DESCRIPTION => 3, self::AUTHOR => 4, self::COPYRIGHT => 5, self::TYPE => 6, self::FILESIZE => 7, self::CREATED_AT => 8, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new sfAssetMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BasesfAssetPeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasesfAssetPeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BasesfAssetPeer', $criteria, $con);
    }
	...
	public static function doCountJoinsfAssetFolder(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(sfAssetPeer::FOLDER_ID,), array(sfAssetFolderPeer::ID,), $join_behavior);
